 ...
 * @Ignore : 이 메소드는 테스트에서 제외. 두 개를 같이 쓰면 테스트에서 제회됨(ex. @Test @Ignore)
 ...
 * @ContextContfiguration("calsspath:config/root-context.xml")
 * - 단위테스트에서 사용 할 빈등록 설정 파일 지정
 */
...
public class BoardDaoTest {
   ...
   public void testInsertBoard() {
	   ...
	   boardVo.setContent("단위테스트로 등록된 게시물내용");
